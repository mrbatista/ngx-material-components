...
export class MatTimeSelectToggleComponent<D>
  implements AfterContentInit, OnChanges, OnDestroy
{
  ...
  get active(): boolean {
    return this.timeSelect && this.timeSelect.opened;
  }

  /** @docs-private */
  @HostBinding("class.mat-accent")
  get accent(): boolean {
    return this.timeSelect && this.timeSelect.color === "accent";
  }

  /** @docs-private */
  @HostBinding("class.mat-warn")
  get warn(): boolean {
    return this.timeSelect && this.timeSelect.color === "warn";
  }
  ...
  private _watchStateChanges() {
    const timeSelectDisabled = this.timeSelect
      ? this.timeSelect.disabledChange
      : of();
    const inputDisabled =
      // eslint-disable-next-line no-underscore-dangle
      this.timeSelect && this.timeSelect._timeSelectInput
        ? // eslint-disable-next-line no-underscore-dangle
          this.timeSelect._timeSelectInput.disabledChange
        : of();
